 ...
 * ## Tolerances
 * - Solar events:
 *   - Time tolerance: 0.8 minutes
 *   - Azimuth tolerance: 0.5°
 * - Lunar events:
 *   - Time tolerance: 0.8 minutes
 *   - Azimuth tolerance: 0.5°
 *
...
internal object TestUtils {
    ...
    private fun assertEqualsWithTolerance(
        ...
        assertTrue(diff <= timeTolerance * 60_000L, "Expected $expected, got $actual (diff: ${diff / 60000} minutes)")
    ...
    private fun assertAzimuthAround(
        ...
        assertTrue(diff <= azimuthTolerance, "Expected azimuth ~$expected°, got $actual°")
    ...
    private fun uiTestInputTime(
        ...
        println(
            "${UI_LOG_CYAN_HEADER}%-16s${UI_LOG_RESET}${UI_LOG_CYAN}%-21s%-26s%-14s%-16s${UI_LOG_RESET}${UI_LOG_GREEN}${UI_LOG_BOLD}%-16s%-12s${UI_LOG_RESET}${UI_LOG_CYAN}%-12.5f${UI_LOG_RESET}".format(
                timeStr,
    ...
    private fun uiTestInputDouble(
        ...
        println(
            "${UI_LOG_CYAN_HEADER}%-16s${UI_LOG_RESET}${UI_LOG_CYAN}%-21s%-26s%-14s%-16.5f${UI_LOG_RESET}${UI_LOG_GREEN}${UI_LOG_BOLD}%-16.5f%-12.5f${UI_LOG_RESET}${UI_LOG_CYAN}%-12.5f${UI_LOG_RESET}".format(
                timeStr,
                "${coordinate.first},${coordinate.second}",
                "$dateTime",
                result,
